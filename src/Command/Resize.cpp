...
namespace prog {
    ...
    namespace command {
        ...
        // Initializes the command with the source rectangle and new dimensions.
        ...
        Image* Resize::apply(Image* img) {
            ...
            // Create new image with desired dimensions, filled with white.
        ...
        // Returns a string describing the resize operation and parameters.
